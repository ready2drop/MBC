...
class MultiModalbileductClassifier_3d(nn.Module):
    def __init__(self, num_classes, num_features,  model_architecture, model_parameters, pretrain_path):
        ...
        self.fc = nn.Sequential(nn.Linear(num_features + self.feature_dim, 256),
                                nn.ReLU(),
                                nn.Dropout(p=0.5),
