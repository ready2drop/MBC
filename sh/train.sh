...
## 3D
python train.py --model_architecture 'SwinUNETR' --epochs 3000 --batch_size 56 --val_every 100 --data_shape '3d' --modality 'mm' --data_path '/home/irteam/rkdtjdals97-dcloud-dir/datasets/Part2_nifti_crop/' --excel_file dumc_0603.csv --use_parallel --use_wandb 
