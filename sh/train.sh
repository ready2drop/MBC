...
## 3D
python train.py --model_architecture 'SwinUNETR' --epochs 2000 --val_every 100 --data_shape '3d' --modality 'mm' --data_path '/home/irteam/rkdtjdals97-dcloud-dir/datasets/Part2_nifti_crop/' --use_parallel --use_wandb 


## Image classification
## 3D
python train.py --model_architecture 'SwinUNETR' --epochs 2000 --val_every 100 --data_shape '3d' --modality 'image' --data_path '/home/irteam/rkdtjdals97-dcloud-dir/datasets/Part2_nifti_crop/' --use_parallel --use_wandb 
