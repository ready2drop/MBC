...
python src/train/CITP_evaluate.py --model_architecture 'ViT' --pretrained_dir '/home/rkdtjdals97/MBC/logs/2024-08-02-16-49-pretrain-mm' --batch_size 1 --hidden_dim 128 --use_parallel --use_wandb
