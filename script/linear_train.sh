...
# python src/train/train_linear.py --model_architecture 'ViT' --batch_size 138 --modality 'mm' --data_path '/home/rkdtjdals97/datasets/DUMC_nifti_crop/' --use_parallel --use_wandb
# python src/train/train_linear.py --model_architecture 'ResNet'  --modality 'mm' --data_path '/home/rkdtjdals97/datasets/DUMC_nifti_crop/' --use_parallel --use_wandb 
