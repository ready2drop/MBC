...
python src/train/train.py --model_architecture 'SwinUNETR' --epochs 3000 --val_every 100 --data_shape '3d' --modality 'image' --data_path '/home/irteam/rkdtjdals97-dcloud-dir/datasets/Part4_nifti_crop/' --use_parallel 
