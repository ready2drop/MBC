...
parser.add_argument("--image_pretrain_path", default='/home/rkdtjdals97/MBC/pretrain/model_swinvit.pt', type=str, help="Image pretrained weight path")
...
parser.add_argument("--fusion", default='intermediate', type=str, help="fusion method") # 'early','intermediate', 'late'
